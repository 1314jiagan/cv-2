...
var div = dom.create("<tr><td>1</td></tr>");
console.log(div);
dom.after(test, div);
var div3 = dom.create("<div id='dov'>3</div>");
// dom.warp(test, div3);
...
var divTest = dom.find("#test")[0]; //不写[0]获取的是数组不是div
console.log(divTest);
...
var b = dom.previous(dom.find("#e2")[0]);
console.log(b);
...
//# sourceMappingURL=/main.da85c459.map